    ...
    <section id="contact" className="py-24 md:py-32 bg-white relative overflow-hidden">
      ...
      >
        ...
        <h2 className="section-heading text-black mb-8 max-w-[800px]">
          ...
          <span className="text-black/25">Your Business Needs</span>
        </h2>

        <p className="text-black/55 font-sans text-[16px] md:text-[18px] leading-[1.65] max-w-[500px] mb-12 font-medium">
          Whether it's a CRM, workflow automation platform, website, or custom business tool, we'll help you create technology that supports growth.
        </p>
